...
/**
 * MainActivity just sets up the main activity. This project uses some
 * advance Kotlin Language features such as using lambdas as anonymous functions and
 * high-order functions...welcome to java trippy trips
 */
class MainActivity : AppCompatActivity() { //read it as class MainActivity extends AppCompatActivity

    //override function onCreate with Bundle as nullable ie ?
    ...
    private fun createTestData() : List<PartData> {
        ...
        partList.add(PartData(101119, "Aluminium Capacitor 4.7Î¼F"))
        partList.add(PartData(101624, "Potentiometer 500kÎ©"))
        return partList
    }
